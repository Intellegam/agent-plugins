...
- SubagentStart hook — short validate-before-returning pointer for implementation-capable sub-agents (general-purpose/claude/dev-coder); read-only agents unaffected
