---
name: agent-behavior
description: Behavioral guidelines to reduce common LLM coding mistakes — think before coding, simplicity first, surgical changes, goal-driven execution. Read when the SessionStart reminder points here, when starting non-trivial implementation work, or when the user asks about coding guidelines or agent behavior.
---
